    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-green-50">
      <div className="text-center space-y-8 p-8">
        <div className="flex items-center justify-center space-x-4">
          <GithubIcon className="w-12 h-12 text-green-900" />
          <h1 className="text-4xl font-bold text-green-900">Repo Analyzer</h1>
        </div>
        ...
        <a 
          ...
          className="inline-flex items-center space-x-3 px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200 text-lg"
        >
